...
export const User = ({email, first_name, last_name, avatar, id, isInvited, onClickInvites}) => (
  <li>
    <div>
    ...
    <img onClick={() => onClickInvites(id)} className="action" src={`/assets/${isInvited ? 'minus.svg' : 'plus.svg'}`} alt="Action" />
  </li>
);
